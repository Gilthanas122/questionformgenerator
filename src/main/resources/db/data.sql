...
VALUES (1, 0, 1, 'ROLE_ADMIN, ROLE_TEACHER', 'admin', '$2a$10$KkPGU7EVwA/ug4.9K/iCA.0vdj4xW2h1hJ0dEvHF8mmyy45foW0AK',
        'admin@admin.com', 'admin-token');

INSERT INTO appusers (id, disabled, active, roles, username, password, email_id, confirmation_token)
VALUES (2, 0, 1, 'ROLE_USER,ROLE_TEACHER', 'teacher', 'teacherpass', 'teacher@teacher.com', 'teacher-token');

INSERT INTO appusers (id, disabled, active, roles, username, password, email_id, confirmation_token)
VALUES (3, 0, 1, 'ROLE_USER', 'user', '$2a$10$1k91J0vUcNZRIOfURLs35O1YlDsEeCAHjiiiddyh0mrmaetXykfWi', 'user@user.com',
        'user-token');

INSERT INTO appusers (id, disabled, active, roles, username, password, email_id, confirmation_token)
VALUES (4, 0, 0, 'ROLE_USER', 'usernotactivated', '$2a$10$1k91J0vUcNZRIOfURLs35O1YlDsEeCAHjiiiddyh0mrmaetXykfWi',
        'usernotactivated@user.com', 'user-not-activated-token');

INSERT INTO appusers (id, disabled, active, roles, username, password, email_id, confirmation_token)
VALUES (5, 0, 1, 'ROLE_USER,ROLE_TEACHER', 'teacher2', 'teacherpass2', 'teacher2@teacher.com', 'teacher-token2');

INSERT INTO appusers (id, disabled, active, roles, username, password, email_id, confirmation_token)
VALUES (6, 0, 1, 'ROLE_USER', 'anotheruser', '$2a$10$1k91J0vUcNZRIOfURLs35O1YlDsEeCAHjiiiddyh0mrmaetXykfWi',
        'anotheruser@user.com', '-another-user-token');
